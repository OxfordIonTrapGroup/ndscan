        ...
        """Specifies the annotation to be plotted. This documentation is likely very
            ...
            Args:
                ...
                coordinates (Optional[dict], optional):
                    ...
                    * For kind == 'curve', should be a dict with 2 entries. Keys are
                    the x axis (ParamHandle) and y axis (ResultChannel), values are
                    lists of points.
                ...
                data (Optional[dict], optional):
                    ...
                    * For kind == 'computed_curve', a dict specifying all the parameters
                    ...
                    parameters['function_name'] field. See the desired fitting function
                    for details.
                    Defaults to None.
        """
        self.kind = kind
